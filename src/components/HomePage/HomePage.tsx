    ...
    <>
      ...
      <div className="grid grid-flow-row place-content-center lg:px-40 md:px-16 px-8 mt-10">
        <div className="grid xl:grid-cols-3 sm:grid-cols-2 ">
          ...
          <div className="grid place-self-center md:place-self-start col-span-3 sm:py-4 xl:py-0 sm:grid-cols-2 sm:col-span-2 xl:col-span-1 xl:grid-cols-1 xl:space-y-2 sm:ml-10">
            <SideNews
